        ...
        <Grid container>
            <Grid item xs={6}>
                <Container maxWidth={false}>
                    ...
                    value={formData.email} onChange={(e) => setFormData({...formData, email: e.target.value})}> Eg: 1000</TextField>
                </Container>
            </Grid>
            <Grid item xs={6}>
                <div>
            ...
            <Grid item xs={6}>
                <div style={{width:"92%", marginLeft: "4%"}}>
                     <TextField label="Area" size="small"
            ...
            <Grid item xs={6}>
                <div>
                    <TextField label="Landmark" size="small"
            ...
            <Grid item xs={6}>
                <div style={{width:"92%", marginLeft: "4%"}}>
                     ...
                     value={formData.latitude} onChange={(e) => setFormData({...formData, latitude: e.target.value})}> Eg: 1000</TextField>
                </div>
            </Grid>
            <Grid item xs={6}>
                <div>
                    <TextField label="Longitude" size="small"
